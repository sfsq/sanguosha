if (/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
	...
	function changeImg() {
		...
		document.getElementById('wujiangName').innerHTML = '当前武将名称：<font size="5" color="#f4ab00">' + (generalMap[
				wujiangId + ''] || '无') +
			'</font>';
		document.getElementById('wujiangId').innerHTML = '当前武将编号：<font size="5" color="#00aaff">' + wujiangId +
			'</font>';
	...
	// PC
	// alert('请使用移动端访问');
	document.body.innerHTML = '请使用移动端访问';
}
